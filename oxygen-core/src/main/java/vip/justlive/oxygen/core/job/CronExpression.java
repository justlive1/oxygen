...
public final class CronExpression implements Serializable {
  ...
  protected static final Map<String, Integer> DAY_MAP = new HashMap<>(60);
  ...
  protected void buildExpression(String expression) throws ParseException {
    ...
    try {
      ...
      while (exprsTok.hasMoreTokens() && exprOn <= YEAR) {
        ...
        if (exprOn == DAY_OF_MONTH && expr.indexOf('L') != -1 && expr.length() > 1 && expr
            .contains(",")) {
  ...
  protected String getExpressionSetSummary(java.util.Collection<Integer> set) {
