...
class SimpleTemplateEngineTest {
  ...
  void t0() {
    ...
    assertEquals("<i>2</i><i>4</i><i>/aaa</i>", result);
  ...
  void t2() {
    ...
    assertEquals("a = 1;b[0]=5;b[1]=9;b[2]=7;", value);
  }
  ...
  void t3() {
    ...
    assertEquals("a + 2 = 3; b = ext;", value);
  }
}
