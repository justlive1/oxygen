...
import vip.justlive.oxygen.web.result.ThymeleafResolver.ResourceTemplateResolver;

/**
 * @author wubo
 */
public class ThymeleafViewResultHandlerTest {
  ...
  public void test() {
    ...
    Assert.assertEquals("<span>xxx</span>", rsp);
  }
}
